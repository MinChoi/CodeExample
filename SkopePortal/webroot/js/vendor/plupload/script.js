$(function() {
	...
	$("#uploader").pluploadQueue({
		...
		filters: [
			{title: "Image files", extensions: "jpg,jpeg,gif,png,gif,ico,psd"},
			{title: "PDF files", extensions: "pdf"},
			{title: "Doc files", extensions: "doc,docx,xls,xlsx,csv,txt,rtf"},
			{title: "HTML files", extensions: "html"},
			{title: "Media files", extensions: "mp3,wma,mpg,flv,avi"},
