...
class AppSchema extends CakeSchema {
	...
	public $email_queue = array(
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1),
			'sent' => array('column' => array('created', 'sent', 'send_tries', 'send_at', 'locked'), 'unique' => 0)
		),
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_general_ci', 'engine' => 'MyISAM')
	);
	...
	public $projects = array(
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1),
			'state' => array('column' => array('state', 'client_id'), 'unique' => 0)
		),
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_general_ci', 'engine' => 'MyISAM')
	);
	...
	public $users = array(
		...
		'indexes' => array(
			'PRIMARY' => array('column' => 'id', 'unique' => 1),
			'firstname' => array('column' => array('firstname', 'status'), 'unique' => 0),
			'email' => array('column' => array('email', 'status'), 'unique' => 0),
			'title' => array('column' => array('title', 'status'), 'unique' => 0)
		),
		'tableParameters' => array('charset' => 'utf8', 'collate' => 'utf8_general_ci', 'engine' => 'MyISAM')
	);
