...
Configure::write('Core.DefaultPageTitle', 'New SurfCMS Site - %TITLE%');

// title used in Admin Area
Configure::write('Core.AdminAreaTitle', 'SurfCMS Admin Area');

// ?
Configure::write('Core.SiteTitle', 'SurfCMS Website');

// Default admin/staff email address to send contact form details and notifications to 
Configure::write('Core.ClientEmail', 'simonovsky@simoneast.net');
...
Configure::write('Core.ErrorNotifications', 'simon@surfacedigital.com.au');

// Defaul theme folder
Configure::write('Core.Theme', 'default');

// AFL ticketmaster urls
Configure::write('Ticketmaster.login', 'https://oss.ticketmaster.com/aps/melbournefc/EN/account/login');
...
// IMPORTANT: This only works if the email is created like:  new CakeEmail('DebugAndLog')
//			  As such, ALL emails should now be called with this constructor (yes, even in production)
if (!isProduction())	// if we are NOT on production
...
Configure::write('Core.AdminMenuTabs', array(
	'admin-dashboard' => array(
		...
		'sub_menu' => array(
			...
			'Widgets' => array('url' => '/admin/widgets'),
		)
	),
	/*'memberHQ' => array(
		'url' => '/admin/clients',
