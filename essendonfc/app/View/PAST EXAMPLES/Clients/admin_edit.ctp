...
<?= $this->CmsForm->create('Client', array(
	'id' => 'clientAdd',
...
<div class="frm-l">
	...
	<?= $this->CmsForm->textbox('Client Name', 'name') ?>
	<?= $this->CmsForm->textareaOld('Client Information', 'information') ?>
	<?= $this->CmsForm->multiChooser('Which staff should have access to view/modify this client\'s documents?', $people) ?>
