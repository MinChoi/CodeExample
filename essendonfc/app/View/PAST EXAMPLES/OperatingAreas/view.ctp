<div class="operatingAreas view">
<h2><?= __('OperatingArea');?></h2>
...
<div class="actions">
	<ul>
		<li><?= $html->link(__('Edit OperatingArea'), array('action' => 'edit', $operatingArea['OperatingArea']['id'])); ?> </li>
		<li><?= $html->link(__('Delete OperatingArea'), array('action' => 'delete', $operatingArea['OperatingArea']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $operatingArea['OperatingArea']['id'])); ?> </li>
...
<div class="related">
	...
	<? if (!empty($operatingArea['Organisation'])):?>
	...
	<?
		$i = 0;
		foreach ($operatingArea['Organisation'] as $organisation):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
