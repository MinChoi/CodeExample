...
<?= $this->CmsForm->create('Friend', array(
	'id' => 'clientAdd',
...
<div class="frm-l">
	...
	<h1>Friends of Madgwicks: User Details</h1>

	<?= $this->element('admin/notices') ?>

	<?= $this->CmsForm->textbox('First Name', 'first_name') ?>
	<?= $this->CmsForm->textbox('Last Name', 'last_name') ?>
	<?= $this->CmsForm->textbox('Position Title', 'position_title') ?>
	<?= $this->CmsForm->textbox('Company or Organisation', 'organisation') ?>
	<?= $this->CmsForm->textbox('Email Address', 'email') ?>
	<?= $this->CmsForm->textbox('Password', 'password') ?>
	<?= $this->CmsForm->textbox('Password confirm', 'password_confirm') ?>
...
<div class="frm-r">
	<?= $this->element('/admin/client/administrator_notes', array('open'=> true)) ?>
</div>
...
<?= $this->element('/admin/client/administrator_notes_forms');?>
