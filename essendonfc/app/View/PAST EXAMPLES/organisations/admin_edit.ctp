...
<?=$this->Form->input('Organisation.id',array('type'=>'hidden'));?>
<div class="frm-l" style="padding:0px;">
	<h3><address>View/Edit Member Organisation</address></h3>
	<ol class="erroruls">
		<? 
		if(isset($errors)){
						...
						<td>
							...
							<div id="member_name_div" style="display:block" class="inline_form">
								...
								<div id="<?=$uniqueid;?>_from">
									...
									<?
										echo $this->request->data['Organisation']['street_address_1'].', ';
										echo $this->request->data['Organisation']['street_address_2'].', ';
										echo $this->request->data['Organisation']['street_suburb'].', ';
										echo $sstates[$this->request->data['Organisation']['street_state_id']].', ';
										echo $countires[$this->request->data['Organisation']['street_country_id']].', ';
										echo $this->request->data['Organisation']['street_postcode'];
									?>
									</span>
						...
						<td>
							...
							<div id="member_name_div" style="display:block" class="inline_form">
								...
								<div id="<?=$uniqueid;?>_from">
									<span id="<?=$uniqueid;?>_label" class="label">
									<?
										echo $this->request->data['Organisation']['postal_address_1'].', ';
										echo $this->request->data['Organisation']['postal_address_2'].', ';
										echo $this->request->data['Organisation']['postal_suburb'].', ';
										echo $pstates[$this->request->data['Organisation']['postal_state_id']].', ';
										echo $countires[$this->request->data['Organisation']['postal_country_id']].', ';
										echo $this->request->data['Organisation']['postal_postcode'];
									?>
									</span>
						...
						<td>
							...
							<div id="member_name_div" style="display:block" class="inline_form">
								...
								<div id="<?=$uniqueid;?>_from">
									...
									<td>
									<span id="web" class="label"><?=$this->request->data['Organisation']['website'];?></span></td>
										</tr>
										<tr><td class="lab">Parent Company:</td>
									<td>
									<span id="parent" class="label"><?=$this->request->data['Organisation']['parent_company'];?></span></td>
										</tr>
			   ...
			   operates</td>
											...
											<?
												if(isset($this->request->data['OperatingArea'])){
													$oas = array();
													if(isset($this->request->data['OperatingArea'][0]['name'])){
														foreach($this->request->data['OperatingArea'] as $OArea){
															$oas[] = $OArea['name'];	
														}
													}else{
														if(isset($this->request->data['OperatingArea']['OperatingArea'])){
										...
										<tr><td class="lab">Industry/Sector:</td>
											...
											<?=$industryTypes[$this->request->data['Organisation']['industry_type_id']];?>
											</span></td>
										</tr>
										<tr><td class="lab">Number of Employees:</td>
											<td><span id="numemp" class="label">
											<?=$memberTiers[$this->request->data['Organisation']['member_tier_id']];?>
											</span></td>
										</tr>
										<tr><td class="lab">Main reason for membership:</td>
											<td><span id="reason" class="label">
											<?=$reasons[$this->request->data['Organisation']['reason_id']];?>
											</span></td>
										</tr>
										<tr>
						...
						<td>
							...
							<script type="text/javascript">
								...
								function populateKeyContacts(){
									var member_id = parseInt($('KeyContactMemberId').value);
									if(member_id>0){
										$('popkc').show();
										new Ajax.Request('/admin/members/getmemberdetails/'+member_id, {
										  method:'get',
										  requestHeaders: {Accept: 'application/json'},
										  onSuccess: function(transport){
											var json = transport.responseText.evalJSON(true);
											$('popkc').hide();
											$('OrganisationKcGname').value 		= 	json.gname;
											$('OrganisationKcEmail').value 		=	json.email;
											$('OrganisationKcLname').value 		=	json.lname;
											$('OrganisationKcPhone').value 		=	json.phone;
											$('OrganisationKcPosition').value 	=	json.position;
										  }
										}); 
									}else{
										$('OrganisationKcGname').value 		= 	'Enter Given Name';
										$('OrganisationKcEmail').value 		=	'Enter Email Address';
										$('OrganisationKcLname').value 		=	'Enter Last Name';
										$('OrganisationKcPhone').value 		=	'Enter Phone Number';
										$('OrganisationKcPosition').value 	=	'Enter Position Title';
									}
								}
								-->
							</script>
							<div id="member_name_div" style="display:block" class="inline_form">
									...
									<table width="100%"> 
										...
										<tr><td class="lab">Position Title:</td>
											...
											<td>
												...
												<?
													echo $this->request->data['Organisation']['kc_address_1'].', ';
													echo $this->request->data['Organisation']['kc_address_2'].', ';
													echo $this->request->data['Organisation']['kc_suburb'].', ';
													echo $kstates[$this->request->data['Organisation']['kc_state_id']].', ';
													echo $countires[$this->request->data['Organisation']['kc_country_id']].', ';
													echo $this->request->data['Organisation']['kc_postcode'];
												?>
								...
								<div id="<?=$uniqueid;?>_from_i" style="display:none;">
									<table border="0" cellpadding="4" cellspacing="0">		
										<tr><td colspan="2">
											<?=$this->Form->input('KeyContact.member_id',array('label'=>false,'div'=>false,'class'=>'focus orgi','empty'=>'-- select a member --','options'=>$members,'onchange'=>'populateKeyContacts()','after'=>'<img src="/img/spinner.gif" alt="loading..." id="popkc" style="display:none;" />'));?>
										</td></tr>
										<tr><td>
...
<div class="frm-r">
	...
	<?=$this->element('/admin/organisation/administrator_notes',array('open'=>true));?>
</div>
<br style="clear:both;" />
	<div id="afm">
		<div id="afm-inner">
...
<?=$this->element('/admin/organisation/administrator_notes_forms');?>
