...
<?= $this->Form->create(null,array('url'=>'/admin/members/nonmemberedit/'.$this->request->data['Member']['id'],'id'=>'nonmemberadd','ENCTYPE'=>'multipart/form-data','method'=>'post'));?>
<?=$this->Form->input('Redirect.redirect',array('type'=>'hidden'));?>
<?=$this->Form->input('Member.id',array('type'=>'hidden'));?>
<div class="frm-l" style="padding:0px;">
	<h3><address>View/Edit Member</address></h3>
	<ol class="erroruls">
		<? 
		if(isset($errors)){
					...
					<tr>
						<td>
							...
							<div id="member_name_div" style="display:block" class="inline_form">
								...
								<div id="<?=$uniqueid;?>_from">
									<span id="<?=$uniqueid;?>_label" class="label"><?=isset($this->request->data['Member']['organisation_id'])&&$this->request->data['Member']['organisation_id']>0?$organisations[$this->request->data['Member']['organisation_id']]:'Enter Organisation Name';?></span>
									<a href="#" class="iedit" onclick="return false;"  id="<?=$uniqueid;?>_edit">Edit</a>
									<? 
									if(intval($this->request->data['Member']['verified_by'])>0){
									?>
								...
								<div id="<?=$uniqueid;?>_from_i" style="display:none;">
									<?=$this->Form->input('Member.organisation_id',array('id'=>$uniqueid.'_txt','label'=>false,'div'=>false,'class'=>'focus fullwidth','focus_txt'=>'Enter Organisation Name','default'=>'Enter Organisation Name','empty'=>'--select an organisation--'));?>
									<a href="#" class="iapply" onclick="return false;" id="<?=$uniqueid;?>_apply" >Apply</a>&nbsp;|&nbsp;<a href="#" class="icancel" onclick="return false;" id="<?=$uniqueid;?>_cancel">Cancel</a>
									<br />
