...
<?= $this->Form->create(null,array('id'=>'individualadd','ENCTYPE'=>'multipart/form-data','url'=>'/admin/members/individualedit/'.$this->request->data['Member']['id'],'method'=>'post'));?>
						...
						<td>
							...
							<div id="member_name_div" style="display:block" class="inline_form">
								...
								<div id="<?=$uniqueid;?>_from_i" style="display:none;">
									...
									<a href="#" class="iapply" onclick="return false;" id="<?=$uniqueid;?>_apply" >Apply</a>&nbsp;|&nbsp;<a href="#" class="icancel" onclick="return false;" id="<?=$uniqueid;?>_cancel">Cancel</a>
									<? 
									if(intval($this->request->data['Member']['active'])==0){
									?>
									<br />
									...
									<? 
										...
										echo $this->Form->input('Member.verified',array('type'=>'hidden'));
									}
									?>
								</div>
							</div>	
						...
						<td>
							<div id="member_name_div" style="display:block" class="inline_form">
								...
								<div style="width:510px;">
									<?//=$this->request->data['Member']['key_contact_info']?>
								</div>
							</div>	
						</td>
					</tr>
